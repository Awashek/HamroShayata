...
const DonationsComponent = () => {
        ...
        const fetchAllDonations = async () => {
            try {
                ...
                if (isMounted) {
                    ...
                    // Extract unique campaigns and statuses for filters
                    const campaigns = [...new Set(formattedData.map(d => d.campaign_title))];
                    const statuses = [...new Set(formattedData.map(d => d.status))];
    ...
    useEffect(() => {
        ...
        // Text search across donor name, campaign title, and transaction ID
        if (searchTerm) {
            ...
            results = results.filter(donation => 
                ...
                donation.transaction_id.toLowerCase().includes(lowercasedSearch)
            );
        }
        
        // Campaign filter
        if (campaignFilter) {
            results = results.filter(donation => donation.campaign_title === campaignFilter);
        }
    ...
    }, [searchTerm, campaignFilter, statusFilter, dateRange, donations]);
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto bg-white rounded-lg shadow-md">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Donations Dashboard</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 rounded-lg shadow text-white">
                    ...
                    <p className="text-3xl font-bold">RS {totalAmount.toFixed()}</p>
                </div>
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg shadow text-white">
                    ...
                    <p className="text-3xl font-bold">RS {last7DaysAmount.toFixed()}</p>
                </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input
                            type="text"
                            placeholder="Search donor, campaign, or ID"
                            value={searchTerm}
