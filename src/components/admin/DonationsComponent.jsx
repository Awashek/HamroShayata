...
const DonationsComponent = () => {
    ...
    // Calculate statistics using only completed donations
    const totalDonations = completedDonations.length;
    const totalAmount = completedDonations.reduce((acc, donation) => acc + parseFloat(donation.amount), 0);
    
    // Calculate amount donated in the last 7 days (only completed)
    const last7DaysDonations = completedDonations.filter(donation =>
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto bg-white rounded-lg shadow-md">
            ...
            <DonationsFilter
                ...
                setDonationsPerPage={setDonationsPerPage}
